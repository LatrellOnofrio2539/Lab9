...
void CPU_Execution(unsigned char opcode, unsigned int machineCode, char *mem){
    ...
    short immediate = machineCode & 0xFFFF;
    unsigned int address = machineCode & 0x03FFFFFF;
    unsigned char function = machineCode & 0x3F;
    ...
    switch (opcode)  // execute different functions when opcode is set differently.
    {
        ...
        case 0b100000://"lb" instruction.
            ...
            regFile[rt] = (char)read_byte(mem, regFile[rs] + immediate);
        ...
        case 0b101001: // "bge" instruction.
            rt = (machineCode >> 16) & 0x1F;
            if (regFile[rs] >= regFile[rt]) {
                PCRegister = (unsigned short)(machineCode & 0xFFFF) * 4;
            }
        ...
        case 0x00: // R-type instructions.
            if (function == 0x20) { // "add" instruction.
